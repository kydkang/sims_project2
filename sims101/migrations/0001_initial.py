    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calculated_value', models.CharField(blank=True, max_length=32, verbose_name='calculated')),
                ('description', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='commons.Description')),
            ],
            options={
                'ordering': ['id'],
                'permissions': [('index_contributor', 'index_contributor'), ('index_validator', 'index_validator')],
            },
        ),
    ]
